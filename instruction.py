...
class Instruction(Enum):
    ...
    #SBC_A_n     = -1, 1, -1,  lambda c, n: SBC(c.r, n)                                                      # ??
    ...
    RST_00H     = 199, 0, 32, lambda c, _: call(c, 0)                                                        # C7
    ...
    RST_08H     = 207, 0, 32, lambda c, _: call(c, 0x08)                                                     # CF
    ...
    RST_18H     = 223, 0, 32, lambda c, _: call(c, 0x18)                                                     # DF
